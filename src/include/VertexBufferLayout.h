...
public:
	...
	{
		m_Elements.push_back({ GL_FLOAT, count, GL_FALSE, 0 });
	...
	{
		m_Elements.push_back({ GL_UNSIGNED_INT, count, GL_FALSE, 0 });
	...
	{
		m_Elements.push_back({ GL_UNSIGNED_BYTE, count, GL_TRUE, 0 });
